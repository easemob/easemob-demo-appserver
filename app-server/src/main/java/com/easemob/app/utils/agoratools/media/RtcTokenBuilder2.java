...
public class RtcTokenBuilder2 {
     ...
     *                        ranging from 1 to (232-1).
     *                        optionalUid must be unique.
     * @param role:           ROLE_PUBLISHER: A broadcaster/host in a live-broadcast
     *                        profile.
     *                        ROLE_SUBSCRIBER: An audience(default) in a
     ...
     * @return The RTC token.
     */
    public String buildTokenWithAccount(String appId, String appCertificate, String channelName, String account,
            Role role, int expire) {
